...
static const uint32_t pogo_keymap_proto3[] = {
	...
	KEY(0, 8, KEY_X), // KEY_B
	KEY(0, 9, KEY_K), // KEY_V
	KEY(0, 10, KEY_E), // KEY_D
	KEY(0, 11, KEY_Q), // KEY_X
	KEY(0, 12, KEY_SEMICOLON), // KEY_Z
	...
	KEY(2, 7, KEY_7),
	KEY(2, 8, KEY_Y), // KEY_T
	KEY(2, 9, KEY_DOT), // KEY_E
	KEY(2, 10, KEY_P), // KEY_R
	KEY(2, 11, KEY_COMMA), // KEY_W
	KEY(2, 12, KEY_APOSTROPHE), // KEY_Q
	...
	KEY(6, 2, KEY_SPACE),
	KEY(6, 3, KEY_Z), // KEY_SLASH
	KEY(6, 4, KEY_V), // KEY_DOT
	KEY(6, 5, KEY_W), // KEY_COMMA
	KEY(6, 6, KEY_M),
	KEY(6, 7, KEY_EQUAL), // KEY_APOSTROPHE
